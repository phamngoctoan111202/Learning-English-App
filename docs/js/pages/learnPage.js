...
const LearnPage = {
            ...
            <div class="learn-container">
                ...
                <div class="card" style="grid-column: 1 / -1; padding: 16px; background: #f5f5f5;">
                    ...
                    <div class="category-filter">
                        ...
                        <label class="filter-radio">
                            <input type="radio" name="learn-category-filter" value="TECHNICAL_WEB" ${savedCategory === 'TECHNICAL_WEB' ? 'checked' : ''}>
    ...
    renderWordQueue() {
        ...
        container.innerHTML = this.wordQueue.map((item, index) => {
            ...
            const last10Length = Database.getLast10AttemptsList(vocab).length;
            ...
            return `
                <div class="${className}" data-index="${index}">
                    ...
                    <span class="queue-item-stats">
                        ${correctAttempts}/${totalAttempts} · ${last10Correct}/${last10Length} gần nhất
                        ${daysAgoBadge}
                    </span>
                </div>
            `;
